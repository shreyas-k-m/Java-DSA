public class Sudoko {
    ...
    public static boolean sudokoSolver(int sudoko[][],int row,int col) { //recursive
        //base case
        if(row == 9 && col == 0) {
            return true;
        }
    ...
    public static void main(String args[]) {
        int sudoko[][] = {{0,0,8,0,0,0,0,0,0},{4,9,0,1,5,7,0,0,2},{0,0,3,0,0,4,1,9,0},{1,8,5,0,6,0,0,2,0},{0,0,0,0,2,0,0,6,0},{9,6,0,4,0,5,3,0,0},
